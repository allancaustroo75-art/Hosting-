...
BRAND       = "SNUKED HOSTING"
BRAND_VER   = "v1"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@SNJKED"
UPDATE_CH   = "https://t.me/@SNUKED"
...
_PHOTO_SPECS: Dict[str, Tuple[str, str, str]] = {
    ...
    "welcome":   ("Wᴇʟᴄᴏᴍᴇ",         "#0F172A", "Sɴᴜᴋᴇᴅ Hᴏsᴛɪɴɢ"),
...
def _handle_bot_upload(m: types.Message) -> None:
    ...
    # Suspicious-filename guard applies to regular users only; admins and
    # owners may upload files with any name (spaces, parentheses, etc.).
    if not is_admin(uid) and not re.match(r"^[A-Za-z0-9._\-]+$", fname):
